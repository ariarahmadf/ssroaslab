...
public class Test extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cbx.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "--- Pilih checkbox ---", "Opsi 1", "Opsi 2", "Opsi 3" }));
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(117, 117, 117)
                .addComponent(cbx, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(41, 41, 41)
                .addComponent(btnSubmit)
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        // TODO add your handling code here:
        if (cbx.getSelectedItem().toString() == "0") {
            System.out.println("");
        } else if (cbx.getSelectedItem().equals(cbx)) {
